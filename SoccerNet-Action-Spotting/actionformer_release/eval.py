...
from libs.utils import valid_one_epoch, ANETdetection, fix_random_seed, act_2_soccer, results_to_dict, post_process
...
def main(args):
    ...
    # cfg['devices'] = ['cuda:3'] # TODO is this correct /home/csgrad/mbhosale/SoccerNet-Action-Spotting/actionformer_release/libs/core/config.py ?
    ...
    if args.saveonly:
        fname = 'eval_results_sc.pkl'
        if args.post_process:
            fname = 'eval_results_sc_pp.pkl'
        output_file = os.path.join(os.path.split(ckpt_file)[0], fname)
