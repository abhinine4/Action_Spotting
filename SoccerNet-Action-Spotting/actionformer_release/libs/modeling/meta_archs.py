...
class PtTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.reg_range = regression_range # Mahesh: Looks like this is the number of levels in multi level transformer encodet.
    ...
    def forward(self, video_list):
        ...
        gt_cls_labels, gt_offsets = self.label_points(
            points, gt_segments, gt_labels) # TODO Mahesh : Does this create gt labels for all the FPN levels.
        ...
        if self.training:    
            ...
            outputs = {'losses':losses, 'result':results}
            return outputs
    ...
    def preprocessing(self, video_list, padding_val=0.0):
        ...
        if self.training:
            ...
            for feat, pad_feat in zip(feats, batched_inputs):
                pad_feat[..., :feat.shape[-1]].copy_(feat) # Mahesh: Just padding with zeros here. 
        else:
            ...
            padding_size = [0, max_len - feats_lens[0]] # TODO Mahesh, any change needed here? it adds the padding here, max sequence length is 2304.
    ...
    @torch.no_grad()
    def label_points(self, points, gt_segments, gt_labels): # Mahesh TODO what exactly is this doing?
    ...
    def label_points_single_video(self, concat_points, gt_segment, gt_label):
        ...
        cls_targets = min_len_mask @ gt_label_one_hot # NOTE Mahesh: Very IMP, this is what converts the cls_targets 
    ...
    def losses(
        ...
        # return a dict of lossespython eva;
        final_loss = (cls_loss * 0.6) + (reg_loss * 0.4)
        return {'cls_loss'   : cls_loss,
                'reg_loss'   : reg_loss,
                'final_loss' : final_loss}
        # final_loss = cls_loss
        # return {'cls_loss'   : cls_loss,
        #         'reg_loss'   : torch.tensor(0.00001, device=cls_loss.device),
        #         'final_loss' : final_loss}
    ...
    def inference_single_video(
        ...
        for cls_i, offsets_i, pts_i, mask_i in zip(
            ...
            #TODO: Change here, if you want to discard regression head.
            # Also point ordering is lost from this point onwards... It is ordered in desceding of the score
