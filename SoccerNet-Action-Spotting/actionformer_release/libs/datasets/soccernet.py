...
class SOCCERNETDataset(Dataset):
    def __init__(
        ...
        self.db_attributes = {
            ...
            'tiou_thresholds': np.linspace(0.3, 0.7, 5), # TODO Mahesh do we need to change anything in db_attributes\. 
    ...
    def _load_json_db(self, json_file):
        ...
        for key, value in json_db.items():
            ...
            if not os.path.exists(feat_file):
                assert(True) # Mahesh, added to verify we have not missed any file or added extra file in annotations.
                continue
    ...
    def __getitem__(self, idx):
        ...
        # feats = feats[:, :]
        feat_stride = self.feat_stride * self.downsample_rate  # TODO Understand how these affect the performance nd what ehy exactly mean. Do we need to change these?
