...
from models.transforms import (Clamp, PermuteAndUnsqueeze, PILToTensor,
                               ...
                               ToFloat, ToUInt8)
from i_o import reencode_video_with_diff_fps
from utils import dp_state_to_normal, show_predictions_on_dataset
...
class ExtractI3D(BaseExtractor):
    ...
    def load_model(self) -> Dict[str, torch.nn.Module]:
        ...
        i3d_weights_paths = {
            'rgb': './sn-spotting/Utils/models/i3d/checkpoints/i3d_rgb.pt',
            'flow': './sn-spotting/Utils/models/i3d/checkpoints/i3d_flow.pt',
        }
        name2module = {}
